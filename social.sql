...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Mar 2025, 00:46
-- Wersja serwera: 10.6.7-MariaDB
-- Wersja PHP: 8.1.1
...
CREATE TABLE `users` (
  ...
  `username_lower` varchar(50) CHARACTER SET utf8mb4 GENERATED ALWAYS AS (lcase(`username`)) STORED,
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `username` (`username_lower`);
